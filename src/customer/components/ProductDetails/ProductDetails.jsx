        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2x1 px-4 pb-16 sm:px-6 lg:max-w-7x1 lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              <h1 className="text-lg lg:text-xl font-semibold text-gray-900 text-left">Universal Outfit</h1>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='opacity-50 text-5m'>5623 Ratings</p>
                  <p className='ml-3 text-5m font-medium text-indigo-600 hover:text-indigo-500'>3768 Reviews</p>
                </div>
              </div>
        ...
        <section>
          ...
          <div className='border p-5'>
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                <h1 className='text-xl font-semibold pb-2 flex items-center space-x-3'>Product Ratings</h1>
                <div className='flex items-center space-x-3'>
                  <Rating read-only value={4.6} precision={.5} />
                  <p className='opacity-60'>53665 Ratings</p>
                </div>
                ...
                <Box className="mt-5 space-y-3">
                  ...
                  <Grid container justifyItems="center" alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      ...
                      }} variant='determinate' value={25} color='warning' />
                    </Grid>
                  </Grid>
